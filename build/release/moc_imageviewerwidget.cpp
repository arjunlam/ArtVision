...
QT_MOC_LITERAL(1, 18, 21), // "messageSetSourceImage"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 7), // "cv::Mat"
QT_MOC_LITERAL(4, 49, 5), // "image"
QT_MOC_LITERAL(5, 55, 19), // "messageSetEdgeImage"
QT_MOC_LITERAL(6, 75, 27), // "messageSetIntersectionImage"
QT_MOC_LITERAL(7, 103, 19) // "onLoadButtonClicked"

    },
    "ImageViewerWidget\0messageSetSourceImage\0"
    "\0cv::Mat\0image\0messageSetEdgeImage\0"
...
void ImageViewerWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->messageSetSourceImage((*reinterpret_cast< const cv::Mat(*)>(_a[1]))); break;
        case 1: _t->messageSetEdgeImage((*reinterpret_cast< const cv::Mat(*)>(_a[1]))); break;
        case 2: _t->messageSetIntersectionImage((*reinterpret_cast< const cv::Mat(*)>(_a[1]))); break;
        ...
        {
            typedef void (ImageViewerWidget::*_t)(const cv::Mat & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageViewerWidget::messageSetSourceImage)) {
                *result = 0;
            }
        }
        {
            typedef void (ImageViewerWidget::*_t)(const cv::Mat & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageViewerWidget::messageSetEdgeImage)) {
                *result = 1;
            }
        }
        {
            typedef void (ImageViewerWidget::*_t)(const cv::Mat & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageViewerWidget::messageSetIntersectionImage)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 0
void ImageViewerWidget::messageSetSourceImage(const cv::Mat & _t1)
{
...
// SIGNAL 1
void ImageViewerWidget::messageSetEdgeImage(const cv::Mat & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void ImageViewerWidget::messageSetIntersectionImage(const cv::Mat & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
